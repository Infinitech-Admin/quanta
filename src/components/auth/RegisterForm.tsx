...
export function SignupForm() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Registering does NOT log the user in — send them to sign in
      // instead of the home page, so they can verify their email and
      // then log in with the account they just created.
      router.push("/login");
      router.refresh();
    } catch {
