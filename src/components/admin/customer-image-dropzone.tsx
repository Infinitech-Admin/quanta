...
interface CustomerImageDropzoneProps {
  label: string;
  helperText?: string;
  value: string | null;
...
// Same-origin Next.js route, forwards to Laravel server-side with auth
// headers attached (see app/api/admin/customers/upload/route.ts). This is
// a dedicated endpoint for customer logos — not shared with brand uploads.
const UPLOAD_ENDPOINT = "/api/admin/customers/upload";
const UPLOAD_FOLDER = "customers";

export function CustomerImageDropzone({
  label,
  helperText,
  value,
  onChange,
