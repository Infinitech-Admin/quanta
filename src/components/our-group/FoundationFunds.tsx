        ...
        <div className="mt-14 grid gap-12 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-[var(--paper)] p-8 shadow-sm ring-1 ring-[var(--leaf)]/15">
            ...
            <blockquote className="mt-5 border-l-2 border-[var(--kraft)] pl-4 font-[var(--font-body)] text-sm italic leading-relaxed text-[var(--ink)]/75">
              &ldquo;I&apos;m hungry most of the time, but I still want to go to
              school, because I want to learn, I want to be successful, so that
              I can take good care of my family when I grow up.&rdquo;
            ...
            <div className="mt-5 space-y-4 font-[var(--font-body)] text-sm leading-relaxed text-[var(--ink)]/80">
              <p>
                ...
                attention span, lower energy, and poor learning retention often
                follow.
              </p>
              <p>
                Quanta Foundation, Inc. sponsors daily meals for hundreds of
                underprivileged Filipino children by partnering with public
                schools across the country, fueling their body, mind, and spirit
          ...
          <div className="rounded-2xl bg-[var(--paper)] p-8 shadow-sm ring-1 ring-[var(--leaf)]/15">
            ...
            <div className="mt-5 space-y-4 font-[var(--font-body)] text-sm leading-relaxed text-[var(--ink)]/80">
              ...
              <p>
                ...
                environmental awareness campaigns, and community education among
                them. We believe that by sustaining Mother Earth, she will
                sustain us in return.
              </p>
            </div>
          </div>
        </div>
