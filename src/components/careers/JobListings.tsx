            ...
            <button
              ...
              className={`rounded-full px-5 py-2 font-[var(--font-body)] text-sm font-medium transition-colors ${
                activeFilter === filter
                  ...
                  : "bg-[var(--paper)] text-[var(--forest-deep)] ring-1 ring-[var(--leaf)]/20 hover:bg-[var(--leaf)]/10"
              }`}
            >
              {filter}
            </button>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          {visibleJobs.map((job) => (
            ...
            >
              ...
              <div className="relative flex w-3 shrink-0 items-center bg-[var(--forest-deep)]">
              ...
              <div className="flex flex-1 items-center justify-between gap-4 p-6">
                <div>
                  <span className="font-[var(--font-body)] text-[11px] font-semibold uppercase tracking-[0.2em] text-[var(--kraft)]">
                    {job.department}
                  </span>
