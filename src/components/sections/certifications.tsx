    ...
    <section className="paper-grain relative overflow-hidden bg-[var(--color-sage-light)] py-16 md:py-20 px-6 md:px-16">
      <div className="relative max-w-6xl mx-auto">
        <div className="mb-10 flex items-center justify-center gap-4">
          <span className="h-px w-10 bg-[var(--color-forest-light)]" />
        ...
        <div className="grid items-center gap-14 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-3 leading-relaxed text-sm md:text-base text-[var(--color-forest-deep)]/80">
              To ensure the consistent quality of our products and services, we
              put in place an{" "}
            ...
            <p className="leading-relaxed text-sm md:text-base text-[var(--color-forest-deep)]/80">
              Our Halal certification guarantees our products and services meet
              the requirements of Islamic law, making them acceptable for the
              Muslim population.
            </p>
          </div>
        </div>
