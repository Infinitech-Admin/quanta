...
export async function POST(request: NextRequest) {
  try {
    ...
    // touched. Works for both single ("file") and multiple ("files[]")
    // uploads, since Laravel tells them apart by field name.
    ...
    console.error("POST /api/admin/brands/upload error:", error);
