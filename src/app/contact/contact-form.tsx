  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-8 inline-flex items-center gap-2 rounded-full bg-[var(--forest)] px-8 py-3 text-sm font-medium text-[var(--paper)] transition-colors hover:bg-[var(--forest-deep)] disabled:cursor-not-allowed disabled:opacity-60"
      >
